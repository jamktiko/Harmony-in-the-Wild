...
public class TrailerCameraDevTool : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerInputHandler.instance.DebugIncreaseMouseSensitivity.WasPressedThisFrame())
        {
            mouseSensitivity += 0.1f;
        }

        else if(PlayerInputHandler.instance.DebugDecreaseMouseSensitivity.WasPressedThisFrame())
        {
            if(mouseSensitivity >= 0.2f)
            {
                mouseSensitivity -= 0.1f;
            }
        }
